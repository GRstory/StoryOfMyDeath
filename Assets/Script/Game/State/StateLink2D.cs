...
public abstract class StateLink2D
{
    ...
    public abstract bool CheckCondition(ICharacter2D character);
    public bool IsValid
    {
...
public class StateLink2DGeneric<Told, Tnew> : StateLink2D where Told : StateBase2D where Tnew : StateBase2D
{
    ...
    private readonly Func<Told, Tnew, ICharacter2D, bool> _checkContition;

    public override StateBase2D OldState => _oldState;
    public override StateBase2D NewState => _newState;

    public StateLink2DGeneric(IEnumerable states, Func<Told, Tnew, ICharacter2D, bool> condition)
    {
    ...
    public override bool CheckCondition(ICharacter2D character)
    {
